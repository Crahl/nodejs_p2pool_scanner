...
io.on('connection', function (socket) {
	...
	exec("perl perl/fetch_rrd.pl perl/rrd/dash.rrd AVERAGE 300 now -24h", function(err, stdout, stderr) {
...
setInterval(function(){
	var exec = require('child_process').exec;
	exec("perl perl/fetch_rrd.pl perl/rrd/dash.rrd AVERAGE 300 now -60s", function(err, stdout, stderr) {
